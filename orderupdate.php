            ...
            foreach ($order_data['refunds'] as $refund) {
                ...
                else 
                {
                    ...
                    if($hasReturnLineItems == true)
                        ...
                        $TransactionTypeDesc = "Manual Refund without line items";
                }
                ...
                if (isset($refund['refund_line_items'])) 
                {
                    ...
                    foreach ($refund['refund_line_items'] as $Rline_item) {
                        ...
                        // Extract discount details
                                // foreach ($Rline_item['discount_allocations'] as $allocation) {
                                ...
                                //         $discount_type = $discount_application['value_type'];
